...
public class PostgresTableInsertWriterProvider extends DefaultTableDataWriteProvider {

  public PostgresTableInsertWriterProvider(ProductFactoryProvider factoryProvider) {
    super(factoryProvider);
  }

  @Override
  public long write(List<String> fieldNames, List<Object[]> recordValues) {
    recordValues.forEach((Object[] row) -> {
